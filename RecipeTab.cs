...
namespace SDA100
{
    public partial class mainForm : Form
    {
        ...
        {
            if (lbxLoadBox.SelectedItem != null)
                {
                string selectedRecipe = Globals.recipeList[lbxLoadBox.SelectedIndex];
                //string selectedRecipe = Globals.recLines[lbxLoadBox.SelectedIndex];
                string[] recData = selectedRecipe.Split(',');

                txtSSRecipeName_Set.Text = recData[1];
                txtSSUserID_Set.Text = recData[2];
                txtSSScanID_Set.Text = recData[3];
                cbxSSWaferSize_Set.Text = recData[4];
                cbxSSEdgeReject_Set.Text = recData[5];
                cbxSSScanOfArea_Set.Text = recData[6];
                //cbxSSZoneScanType_Set.Text = recDate[7]; //add later...currently disabled
                if (recData[8] == "TRUE")
                {
                ...
                //recipeNameDefault = recData[9]; will go here
                txtSizeClass_Size1_Limit.Text = recData[10];
                txtSizeClass_Size2_Limit.Text = recData[11];
                txtSizeClass_Size3_Limit.Text = recData[12];
                txtSizeClass_Size4_Limit.Text = recData[13];
                txtSizeClass_Size5_Limit.Text = recData[14];
                txtSizeClass_Size6_Limit.Text = recData[15];
                txtSizeClass_Size7_Limit.Text = recData[16];
                txtSizeClass_Total_Limit.Text = recData[17];
                txtRecipeComments.Text = recData[18];
            }
        }
        ...
        public void btnSave_Click(object sender, EventArgs e)
        {
            ...
            CreateRecipeString();
            Globals.recipeList.Add(recSaveData);

            System.IO.File.WriteAllLines(Globals.dirRecipe + "\\SDA100rec.txt", Globals.recipeList);
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Globals.recipeList.RemoveAt(lbxLoadBox.SelectedIndex);
        ...
        private void OldAssWayOfCleaningUpRecipes()
        {
            ...
            foreach (string recipe in Globals.recipeList)
            {
                string[] reclinesParsed = recipe.Split(',');
                lbxLoadBox.Items.Add(reclinesParsed[1] + "\t - \t" + reclinesParsed[0]);
            }
        }
    }
